...
VALUES (N'FPT Hackathon Mùa 2 - Cập Nhật', 'fpt-hackathon-mua-2-cap-nhat', N'Cuộc thi công nghệ FPT', 'IN_PROGRESS', GETDATE(), DATEADD(day, 30, GETDATE()), 2);
GO

-- 5. Tạo Track (ID = 1)
INSERT INTO track (name, description, hackathon_event_id)
VALUES (N'AI & IoT', N'Phát triển giải pháp công nghệ kết hợp AI và IoT', 1);
GO
...
VALUES 
(N'Vòng Sơ Loại', N'Vòng loại trực tiếp đánh giá sản phẩm ban đầu', '2026-06-10T00:00:00', '2026-06-11T20:00:00', 1, 1, 2),
(N'Vòng Chung Kết', N'Vòng chung kết thuyết trình sản phẩm', '2026-06-12T08:00:00', DATEADD(minute, -5, GETDATE()), 1, 2, 1);
GO

-- 7. Tạo Tiêu chí (ID = 1)
INSERT INTO criterion (name, description, max_score, weight, hackathon_event_id)
VALUES (N'Tính Sáng Tạo', N'Ý tưởng đột phá và mới lạ', 10, 2, 1);
GO
...
VALUES (N'Super Coders', N'AI Waste Bin', N'Thùng rác AI phân loại tự động', 1, 1, 'ACTIVE', GETDATE());
...
-- 11. Phân công giám khảo chấm bài Vòng 2 (judge1 ID = 4 chấm bài ID = 1)
INSERT INTO judge_assignment (judge_id, submission_id, assigned_by_organizer_id, status, assigned_at)
VALUES (4, 1, 2, 'ASSIGNED', GETDATE());
GO
...
VALUES (4, 1, 1, 9, N'Sản phẩm hoàn thiện rất xuất sắc!', GETDATE(), 1);
GO
